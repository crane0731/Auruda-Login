...
import com.sw.AurudaLogin.dto.AdminUserResponse;
import com.sw.AurudaLogin.dto.UpdateUserRequest;
import com.sw.AurudaLogin.dto.AdminUserListResponse;
import com.sw.AurudaLogin.dto.UserResponse;
...
public class UserController {
    ...
    public ResponseEntity<Object> updateUser(@RequestHeader("User-Id") Long userId,@Valid @RequestBody UpdateUserRequest request, BindingResult  bindingResult){
        ...
        if (!errorMessages.isEmpty()) {
            ...
            User updateUser = userService.update(user.getId(), request);

            UserResponse userResponse = UserResponse.builder()
                    .email(updateUser.getEmail())
                    .nickname(updateUser.getNickname())
                    .profileImageUrl(updateUser.getProfileImageUrl())
                    .point(updateUser.getPoint())
                    .Grade(updateUser.getGrade().getCommentary())
                    .createdAt(updateUser.getCreatedAt().toString())
                    .role(updateUser.getRole().toString())
                    .build();
